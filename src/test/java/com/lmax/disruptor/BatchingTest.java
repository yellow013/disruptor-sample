...
public class BatchingTest {
	...
	public void shouldBatch() throws Exception {
		Disruptor<LongEvent> d = new Disruptor<LongEvent>(LongEvent.FACTORY, 2048, DaemonThreadFactory.INSTANCE,
		...
		while (handler1.processed != eventCount - 1 || handler2.processed != eventCount - 1) {
			Thread.sleep(1);
		}
