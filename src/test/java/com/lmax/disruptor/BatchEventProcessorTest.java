...
public final class BatchEventProcessorTest {
	...
	public void shouldThrowExceptionOnSettingNullExceptionHandler() {
		final BatchEventProcessor<StubEvent> batchEventProcessor = new BatchEventProcessor<StubEvent>(ringBuffer,
				sequenceBarrier, new ExceptionEventHandler());
	...
	public void reportAccurateBatchSizesAtBatchStartTime() throws Exception {
		...
		final BatchEventProcessor<StubEvent> batchEventProcessor = new BatchEventProcessor<StubEvent>(ringBuffer,
				sequenceBarrier, new LoopbackEventHandler());
	...
	public void shouldNotPassZeroSizeToBatchStartAware() throws Exception {
		...
		final BatchEventProcessor<StubEvent> batchEventProcessor = new BatchEventProcessor<>(ringBuffer,
				new DelegatingSequenceBarrier(this.sequenceBarrier), eventHandler);
